...
function hashKey(key, secret) {
  if (!secret) throw new Error('hashKey() requires SESSION_SECRET.');
...
module.exports = { COOKIE_NAME, generateAnonId, generatePostNumber, generateRecoveryKey, hashKey, getUidFromReq, setUidCookie };
