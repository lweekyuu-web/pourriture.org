...
- **ORM**: Prisma 5.18 — schema at `prisma/schema.prisma` (provider: `postgresql`)
- **Seed**: `prisma/seed.js` — creates 6 boards, 10 users, 8 badges, 10 threads (incl. sticky/locked/archived), 2 board moderators, 2 reports, 1 warning, 4 moderation actions
...
- Source lives at the repository root
- Source is bind-mounted (`./:/app`) so edits hot-reload
