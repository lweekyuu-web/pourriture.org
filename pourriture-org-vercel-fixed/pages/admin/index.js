...
export async function getServerSideProps({ req }) {
  ...
  const [boards, threads, posts, users, reports, archived, banned, badges, boardRequests] = await Promise.all([
  ...
  return { props: { stats: { boards, threads, posts, users, reports, archived, banned, badges, boardRequests, mostActiveBoard } } };
}
...
--------------------------------`}</pre>
    <p>
      [<Link href="/admin/boards">Boards</Link>] [<Link href="/admin/board-requests">Board Requests</Link>] [<Link href="/admin/reports">Reports</Link>] [<Link href="/admin/users">Users</Link>] [<Link href="/admin/badges">Badges</Link>] [<Link href="/admin/moderators">Moderators</Link>] [<Link href="/admin/widgets">Widgets / Ads</Link>] [<Link href="/admin/settings">Settings</Link>] [<Link href="/admin/security">Security / IP</Link>] [<Link href="/mod">Moderator Space</Link>] [<Link href="/status">Statistics</Link>] [<Link href="/">Back to site</Link>]
    </p>
