...
export async function getServerSideProps({ req }) {
  ...
  const [boards, threads, posts, users, reports, archived, banned, badges, boardRequests, profileMedia] = await Promise.all([
  ...
  return { props: { stats: { boards, threads, posts, users, reports, archived, banned, badges, boardRequests, profileMedia, mostActiveBoard } } };
}
